...
;;                (dracula-pro-blade-bg       "#212C2A" "#1F2E2B" nil)             ; Background
                (dracula-pro-blade-bg       "#062626" "#1F2E2B" nil)             ; Background
                ...
                (dracula-pro-blade-current-line  "#0b3335" "#3D5C56" "brightblack")   ; Current-line/selection
                (dracula-pro-blade-comment  "#50d53c" "#6AAFA2" "blue")          ; Comment
      ...
      (faces '(;; default
               ...
               (hl-line :background ,dracula-pro-blade-current-line :extend t)
