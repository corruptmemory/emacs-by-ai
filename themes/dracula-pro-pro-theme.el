;;; dracula-pro-pro-theme.el --- Dracula Pro Pro theme
...
(let ((colors '(;; Upstream theme color
                ...
                (dracula-pro-pro-hl-line  "#17161e" "#17161e" "black")         ; Current-line/selection
                ...
                (dracula-pro-pro-bright-blue   "#0000ff" "#0000ff" "brightblue")        ; Bright blue
                ;; Other colors
                (dracula-pro-pro-bg-active-modeline         "#454158" "#433D5C" "brightmagenta")
                (dracula-pro-pro-bg-active-modeline-box     "#FFCA80" "#F9C986" "brightred")
                (dracula-pro-pro-bg-inactive-modeline       "#201F2E" "#2B293D" "brightblack")
                (dracula-pro-pro-bg-inactive-modeline-box   "#9580FF" "#9986F9" "brightmagenta")
                (dracula-pro-pro-bg-fringe                  "#17161e" "#36334C" "brightblack")
      ...
      (faces '(;; default
               ...
               (fringe :background ,dracula-pro-pro-bg-fringe :foreground ,dracula-pro-pro-bg-fringe)
               (highlight :foreground ,dracula-pro-pro-fg2 :background ,dracula-pro-pro-bright-blue)
               (hl-line :background ,dracula-pro-pro-hl-line :extend t)
               (info-quoted-name :foreground ,dracula-pro-pro-orange)
               (info-string :foreground ,dracula-pro-pro-yellow)
               (lazy-highlight :foreground ,dracula-pro-pro-fg :background ,dracula-pro-pro-bright-blue)
               ...
               (match :background ,dracula-pro-pro-current :foreground ,dracula-pro-pro-yellow :weight bold)
               (minibuffer-prompt
...
;;               (region :inherit match :extend t)
               (region :inherit nil :extend t :background ,dracula-pro-pro-bright-blue)
               ...
               ;; isearch
               (isearch :foreground ,dracula-pro-pro-bg :background ,dracula-pro-pro-yellow :weight bold)
               ...
               ;; mode-line
               (mode-line :background ,dracula-pro-pro-bg-active-modeline
                          :box ,dracula-pro-pro-bg-active-modeline-box :inverse-video nil
                          ,@(if dracula-pro-pro-alternate-mode-line-and-minibuffer
               ...
               (mode-line-inactive
                ...
                ,@(if dracula-pro-pro-alternate-mode-line-and-minibuffer
                    ...
                    (list :foreground dracula-pro-pro-fg :background dracula-pro-pro-bg-inactive-modeline :box dracula-pro-pro-bg-inactive-modeline-box)))
               ;; mu4e
